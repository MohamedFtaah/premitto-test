...
export default function PuyPage() {
    return (
        <div className='mx-auto max-w-2xl  py-8 px-4 sm:px-6 lg:px-8 sm:py-12 lg:max-w-7xl flex flex-col justify-center items-center text-center'>
            ...
            <h2 className='   text-6xl my-8 w-1/2'
            ...
            <div className=' px-24 py-5 border-2 border-neutral-700 rounded-2xl'>
                <div className=' flex flex-col p-16 px-28 border-b-2 border-neutral-600'>
                    <h className=' text-6xl mb-5'>79 SAR<span className=' text-base text-neutral-500 '>/month</span></h>
