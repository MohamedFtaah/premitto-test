...
import img1 from '../../imgs/Mobile app store badge.png'
import img2 from '../../imgs/Mobile app store badge (2).png'
    ...
    return (
        <div className='mx-auto max-w-2xl  py-8 px-4 sm:px-6 lg:px-8 sm:py-12 lg:max-w-7xl'>
            ...
            <div className=' border-b-2 border-neutral-500 '>
                <ul className=' flex justify-between md:w-3/4 my-5 mt-16 max-sm:text-xs max-sm:flex-wrap'>
                    <li>Home</li>
                    <li>About us</li>
                    <li>HOW it works</li>
                    <li>Faq</li>
